...
Begin VB.Form frm_graph_water 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Water Consuption Graph"
   ClientHeight    =   8130
   ClientLeft      =   150
   ClientTop       =   420
   ClientWidth     =   11370
   Icon            =   "frm_graph_water.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8130
   ...
   Begin VB.PictureBox Picture1 
      ...
      Top             =   0
      Width           =   11295
      Begin MSChart20Lib.MSChart chart_water 
         Height          =   7905
         Left            =   0
         OleObjectBlob   =   "frm_graph_water.frx":2052
         TabIndex        =   1
         Top             =   0
         Visible         =   0   'False
         Width           =   11115
   ...
   End
End
Attribute VB_Name = "frm_graph_water"
...
doc = current_form
Call DisableX(frm_water(doc))

With frm_water(doc).chart_water
    .RowCount = 1
    .ColumnCount = 2
    .ChartData = doc_props(doc).dados.water
...
frm_water(doc).chart_water.EditCopy
End Sub
