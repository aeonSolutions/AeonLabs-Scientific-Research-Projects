...
Begin VB.Form frm_graph_so2 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "SO2 Emissions Graph"
   ClientHeight    =   8130
   ClientLeft      =   150
   ClientTop       =   420
   ClientWidth     =   11370
   Icon            =   "frm_graph_so2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8130
   ...
   Begin VB.PictureBox Picture1 
      ...
      Top             =   0
      Width           =   11295
      Begin MSChart20Lib.MSChart chart_so2 
         Height          =   7905
         Left            =   0
         OleObjectBlob   =   "frm_graph_so2.frx":2052
         TabIndex        =   1
         Top             =   0
         Visible         =   0   'False
         Width           =   11115
   ...
   End
End
Attribute VB_Name = "frm_graph_so2"
...
doc = current_form
Call DisableX(frm_so2(doc))

With frm_so2(doc).chart_so2
    .RowCount = 1
    .ColumnCount = 2
    .ChartData = doc_props(doc).dados.so2
...
frm_so2(doc).chart_so2.EditCopy
End Sub
