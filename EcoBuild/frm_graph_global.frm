...
Begin VB.Form frm_graph_global 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Global Analysis Graph"
   ClientHeight    =   8130
   ClientLeft      =   150
   ClientTop       =   420
   ClientWidth     =   11370
   Icon            =   "frm_graph_global.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8130
   ...
   Begin VB.PictureBox Picture1 
      ...
      Top             =   0
      Width           =   11295
      Begin MSChart20Lib.MSChart chart_global 
         Height          =   7905
         Left            =   0
         OleObjectBlob   =   "frm_graph_global.frx":2052
         TabIndex        =   1
         Top             =   0
         Visible         =   0   'False
         Width           =   11115
   ...
   End
End
Attribute VB_Name = "frm_graph_global"
...
doc = current_form
Call DisableX(frm_global(doc))

With frm_global(doc).chart_global
    .RowCount = 1
    .ColumnCount = 2
    .ChartData = doc_props(doc).dados.total
...
frm_global(doc).chart_global.EditCopy
End Sub
