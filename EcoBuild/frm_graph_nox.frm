...
Begin VB.Form frm_graph_nox 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "NOx Emissions Graph"
   ClientHeight    =   8130
   ClientLeft      =   150
   ClientTop       =   420
   ClientWidth     =   11370
   Icon            =   "frm_graph_nox.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8130
   ...
   Begin VB.PictureBox Picture1 
      ...
      Top             =   0
      Width           =   11295
      Begin MSChart20Lib.MSChart chart_nox 
         Height          =   7905
         Left            =   0
         OleObjectBlob   =   "frm_graph_nox.frx":2052
         TabIndex        =   1
         Top             =   0
         Visible         =   0   'False
         Width           =   11115
   ...
   End
End
Attribute VB_Name = "frm_graph_nox"
...
doc = current_form
Call DisableX(frm_nox(doc))

With frm_nox(doc).chart_nox
    .RowCount = 1
    .ColumnCount = 2
    .ChartData = doc_props(doc).dados.nox
...
frm_nox(doc).chart_nox.EditCopy
End Sub
