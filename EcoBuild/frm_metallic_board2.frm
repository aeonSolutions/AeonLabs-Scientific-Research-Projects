VERSION 5.00
Begin VB.Form frm_metallic_board2 
   ...
   ClientTop       =   360
   ClientWidth     =   9465
   Icon            =   "frm_metallic_board2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3915
   ...
   Begin VB.Image Image1 
      Height          =   2250
      Left            =   30
      Picture         =   "frm_metallic_board2.frx":324A
      Top             =   540
      Width           =   3000
   End
End
Attribute VB_Name = "frm_metallic_board2"
...
Unload Me
frm_metallic_board3.Show 1
End Sub

Private Sub Form_Load()
 Dim i As Integer
 
Call DisableX(frm_metallic_board2)
Call load_profiles
...
If enabler("Metallic", "Costs") <> "Null" Then
    costs_txt.Text = enabler("Metallic", "Costs")
