...
Begin VB.MDIForm frmMain 
   ...
   Begin VB.Menu menu_Material 
      ...
      Begin VB.Menu menu_MaterialInsert 
         ...
         Shortcut        =   ^I
      End
      Begin VB.Menu menu_Materialedit 
         Caption         =   "&Edit"
         Shortcut        =   ^E
      End
      Begin VB.Menu menu_MaterialDelete 
         Caption         =   "&Delete"
         Shortcut        =   ^D
      End
...
' Set CancelError is True
  ...
  For i = 1 To n
     With document(cur_doc)
       ...
       .lista.col = 1
       .lista.CellAlignment = 4
       .lista.Text = (CStr(material(i).l))
       .lista.col = 2
       .lista.CellAlignment = 4
       .lista.Text = (CStr(material(i).area))
       .lista.col = 3
       .lista.CellAlignment = 4
       .lista.Text = (CStr(material(i).k))
       .lista.col = 4
       .lista.CellAlignment = 4
       .lista.Text = (CStr(material(i).q0))
       .lista.col = 5
       .lista.CellAlignment = 4
       .lista.Text = (CStr(material(i).t1))
       .lista.col = 6
       .lista.CellAlignment = 4
       .lista.Text = (CStr(material(i).g0))
       .lista.col = 7
       .lista.CellAlignment = 4
       .lista.Text = (CStr(material(i).n))
       .lista.col = 8
       .lista.CellAlignment = 4
       .lista.Text = (CStr(material(i).e))
       .lista.col = 9
       .lista.CellAlignment = 4
...
Public Sub savefile()
  ...
  For i = 1 To FState(cur_doc).Conta - 1
     ...
     material(i).l = CDbl(document(cur_doc).lista.Text)
     document(cur_doc).lista.col = 2
     material(i).area = CDbl(document(cur_doc).lista.Text)
     document(cur_doc).lista.col = 3
     material(i).k = CDbl(document(cur_doc).lista.Text)
     document(cur_doc).lista.col = 4
     material(i).q0 = CDbl(document(cur_doc).lista.Text)
     document(cur_doc).lista.col = 5
     material(i).t1 = CDbl(document(cur_doc).lista.Text)
     document(cur_doc).lista.col = 6
     material(i).g0 = CDbl(document(cur_doc).lista.Text)
...
Private Sub menu_FileSave_Click()
 ...
 If FState(cur_doc).deleted Then
  ...
  End If
  ' get the name file and the path
  name = FState(cur_doc).name
  path = FState(cur_doc).path
  ChDir path
  ReDim material(FState(cur_doc).Conta - 1)
  For i = 1 To FState(cur_doc).Conta - 1
     document(cur_doc).lista.row = i
...
Private Sub menu_MaterialDelete_Click()
tipo = "delete"
Load delete_material
delete_material.Show 1

End Sub

Private Sub menu_Materialedit_Click()
    Dim i As Integer
    tipo = "edit"
    i = current_form()
    If FState(i).Conta > 1 Then
